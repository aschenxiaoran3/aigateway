...
const BASE_SKILL_CONTRACTS = [
  ...
  createSkillContract({
    ...
    inputs: ['project_topology', 'symbols', 'cross_repo_edges', 'api_contracts', 'frontend_request_map', 'er_model', 'event_catalog', 'business_terms', 'business_actions', 'frontend_journeys', 'state_machines', 'aggregate_candidates'],
